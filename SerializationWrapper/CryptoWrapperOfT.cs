...
{
	[Serializable()]
	public class CryptoWrapper<T> : CryptoWrapperBase
	{
	  ...
	  public T GetObject(string base64Key)
	  {
	  ...
	  /// <param name="base64Key">Base64 encoded byte array containing the encryption key</param>
	  /// <returns>The wrapped object</returns>
	  public T GetObject(AlgorithmType calg, string base64Key)
	  {
	  ...
	  /// <param name="base64Key">Base64 encoded byte array containing the encryption key</param>
	  public CryptoWrapper(T wrappedObject, string base64Key) : this(wrappedObject, AlgorithmType.TripleDES, base64Key)
	  ...
	  /// <param name="base64Key">Base64 encoded byte array containing the encryption key</param>
	  public CryptoWrapper(T wrappedObject, AlgorithmType calg, string base64Key)
	  {

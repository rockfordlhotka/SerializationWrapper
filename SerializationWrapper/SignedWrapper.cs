...
{
	[Serializable()]
	public class SignedWrapper : SignedWrapperBase
	{
	...
	#region  Sign data 
	  ...
	  /// <param name="halg">The type of hash algorithm to use</param>
	  /// <param name="base64Key">Base64 encoded byte array containing the hash key</param>
	  public SignedWrapper(object wrappedObject, AlgorithmType halg, string base64Key)
	  {
	  ...
	  /// <param name="wrappedObject">The object to be signed</param>
	  /// <param name="base64Key">Base64 encoded byte array containing the hash key</param>
	  public SignedWrapper(object wrappedObject, string base64Key)
	  {
